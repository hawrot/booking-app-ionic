...
export class NewOfferPage implements OnInit {
  ...
  constructor(private placeServ: PlacesService, private router: Router, private loadingController: LoadingController) { }
  ...
  onCreateOffer(){
    ...
    this.loadingController.create({
      ...
      loadingEl.present();
      this.placeServ.addPlace(this.form.value.title, this.form.value.description, +this.form.value.price, new Date(this.form.value.dateFrom), new Date(this.form.value.dateTo)).subscribe(()=>{
        loadingEl.dismiss();
        this.form.reset();
